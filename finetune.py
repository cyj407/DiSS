...
from guided_diffusion.guided_diffusion.image_datasets import load_data_finetune
...
def main():
    ...
    model.load_state_dict(
        dist_util.load_state_dict(args.trained_model, map_location="cpu")
    )
